...
static int quorem(_Jv_Bigint *b, _Jv_Bigint *S)
{
  int n;
  long borrow, y;
...
char * _dtoa_r(struct _Jv_reent *ptr, double _d, int mode, int ndigits,
	int *decpt, int *sign, char **rve, int float_type)
{
  /*
...
void _dtoa(double _d, int mode, int ndigits, int *decpt, int *sign,
